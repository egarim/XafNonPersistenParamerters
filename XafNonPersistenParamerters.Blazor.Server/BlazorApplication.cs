...
namespace XafNonPersistenParamerters.Blazor.Server {
    public partial class XafNonPersistenParamertersBlazorApplication : BlazorApplication {
        public XafNonPersistenParamertersBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void XafNonPersistenParamertersBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
