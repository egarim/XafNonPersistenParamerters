...
namespace XafNonPersistenParamerters.Module.DatabaseUpdate {
    ...
    public class Updater : ModuleUpdater {
        ...
        public override void UpdateDatabaseAfterUpdateSchema() {
            ...
            if (this.ObjectSpace.GetObjectsCount(typeof(Category),null)==0)
            {
                this.ObjectSpace.CreateObject<Category>().Name="Cat 1";
                this.ObjectSpace.CreateObject<Category>().Name = "Cat 2";
                this.ObjectSpace.CreateObject<Category>().Name = "Cat 3";


                this.ObjectSpace.CreateObject<DirectoryParams>().Name = "Param 1";
                this.ObjectSpace.CreateObject<DirectoryParams>().Name = "Param 2";
                this.ObjectSpace.CreateObject<DirectoryParams>().Name = "Param 3";
            }
